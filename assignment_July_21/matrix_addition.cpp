...
void matrix_addition (int matrix_1[3][3], int matrix_2[3][3], int result[3][3]) {
...
int main() {
    ...
    cout << endl << "Thank you. The result of the addition of matrix 1 with matrix 2 is: " << endl << endl;
    ...
    matrix_addition(matrix_1, matrix_2, result);
